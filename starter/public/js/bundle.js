...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2FyYXRoa3VtYXJrcyIsImEiOiJja3FoemR2NnIwNHZpMnV0ajBrcDNob2MxIn0.yt-9zuxlO-nfN41v15_gAQ';
...
var stripe = Stripe('pk_test_51JA6kFSFRv4Bx3KPMIeaHqCRExtUp6joIHShBKv0QQhtwW6Df4Ns8loDrg3Mm6wuNlE5Xy07AQjzCPCTLFPhNFi200x4WJac8o');
...
if (userPasswordForm) userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    var currPass, newPassword, newPasswordConfirm;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            currPass = document.getElementById('password-current').value;
